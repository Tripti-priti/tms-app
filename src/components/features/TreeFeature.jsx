...
function ExpandIcon(props) {
  return <>
    ...
    <AddBoxRoundedIcon {...props} sx={{ opacity: 0.8 }} />
...
function CollapseIcon(props) {
  ...
  <div style={{display:'flex',justifyContent:'center', alignItems:'center',marginRight:'10px'}}>
     ...
     <Checkbox defaultChecked sx={{ opacity: 0.8,zIndex:'10' }} />
  </div>
...
function EndIcon(props) {
  return <>
    <Checkbox defaultChecked />
    {/* <DisabledByDefaultRoundedIcon {...props} sx={{ opacity: 0.3 }} /> */}
  </>;
}
...
export default function BorderedTreeView() {
  return (
    <SimpleTreeView
      ...
      sx={{  minHeight: 270, flexGrow: 1, maxWidth: 400,left:'20px' }}
    >
